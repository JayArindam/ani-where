...
function AboutUs () {
    return (
        <>
            ...
            <p>Founded by a group of anime-loving adventurers, Aniwhere is on a mission to make every trip feel like the start of a new season in your life. Whether you’re chasing cherry blossoms or hunting down ramen shops straight out of <em>Naruto</em>, we’re here to ensure your journey is as memorable as the final battle of a shounen epic.</p>

            <p><strong>Why Choose Aniwhere?</strong></p>
